...
public class RandomShape extends JPanel {
    ...
    private List<Shape> createShapeList() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            int randomDelayedStart = random.nextInt(500);
            int colorIndex = random.nextInt(colors.size());
            Color color = colors.get(colorIndex);
            list.add(new Shape(randXLoc, radius, randomDelayedStart, color));
        }
    ...
    class Shape {
        ...
        public Shape(int randXLoc, int radius, int randomDelayedStart, Color color) {
        ...
        public void drawShape(Graphics g) {
            if (draw) {
                g.setColor(color);
                g.fillOval(randXLoc, y, radius, radius);
            }
        }
